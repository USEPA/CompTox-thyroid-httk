...
1. High-throughput screening (HTS) data: concentration-response profiling data on thyroid-related endpoints from the US EPA's ToxCast program for thousands of chemicals (`data/invitrodb_v3_5_thyroid_data.RData`)
...
4. _In vivo_ toxicity information from repeat-dose studies summarized from the US EPA ToxValDB for over 7000 substances (`data/toxval pods chemical level oral mgkgday.xlsx`). 
