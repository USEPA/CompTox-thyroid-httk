...
# interesting chems above the red line 
pdata3 %>% 
...
dio.aeds <- tissue.bers[variable == 'aed' & min_ber <= 3, 
                    .(dtxsid, chnm, enzyme, variable, body, tissue, value, min_ber)]
...
mc5.dio.priority <- mc5[dsstox_substance_id %in% priority.chems]
