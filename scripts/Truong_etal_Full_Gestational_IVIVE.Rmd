...
![Figure 1 from *Truong et al. 2025*](../figures/fig1-workflow-v5.png){width=100%}
...
(load('./data/old/invitrodb_v3_5_deiod_filtered_httk_toxsubmission.RData', envir = e))
...
#        width = 190, height = 150,
#        device = "png",
#        filename = "./figures/preg_prioritization_by_BER-v5.2.png")
...
## Table 7 
```{r table-7, warning = FALSE, eval = execute.vignette}
targets <- c('DIO1', 'DIO2', 'DIO3', 'IYD')
...
#        width = 190, height = 100,
#        device = "png",
#        filename = "./figures/BER_uncertainty-v4.png")
