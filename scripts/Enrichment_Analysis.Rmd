...
# processed data - contains data with old classifications (from using ClassyFire alone)
load('./data/Deiodinases/DIO-IYD_invitrodb_v3_5_qSAR_ready.RData', verbose = T)
...
The top 20 classes in each library for that assay are shown here. 
Classes that made up less than 1% of the library for that assay shown here were regrouped into a broader and relevant "Other_[classes from Classyfire|Drugs|Expert chemicals|Pesticides|PFAS categories]" category. 
...
ggsave(plot = uniq.positives,
       ...
       width = 15, height = 12,
       device = "tiff",
       filename = "./doc/comptox-thyroid-httk/figures/300dpi/uniq_positives.tiff")
...
ggsave(plot = uniq.positives,
       ...
       width = 15, height = 12,
       device = "png",
       filename = "./doc/comptox-thyroid-httk/figures/uniq_positives.png")
...
ggsave(plot = fig, 
       ...
       width = 10, height = 19, 
       device = "tiff", 
       filename = "./doc/comptox-thyroid-httk/figures/300dpi/longchainc_panactive.tiff")
...
ggsave(plot = fig, 
       ...
       width = 10, height = 19, 
       device = "png", 
       filename = "./doc/comptox-thyroid-httk/figures/longchainc_panactive.png")
